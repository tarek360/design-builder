 ...
 */
abstract class UseCase<T, Params> internal constructor(private val executionScheduler: ExecutionScheduler) {
    ...
    open fun execute(observer: DisposableObserver<T>, params: Params) {
        ...
        val observable = this.buildUseCaseObservable(params)
                .subscribeOn(executionScheduler.executionScheduler)
                .observeOn(executionScheduler.postExecutionScheduler)
